...
-- root@localhost	HARSHA	8.4.6	2025-09-03 20:13:36
...
values(200 ,'Harsha M', 'harsham@gmail.com' ,'Male' ,89 , 90 ,95 );
...
Due Sep 3
dear students
    Complete the tutorial as discussed in the class and submit the complete solution. ( use select *from tablename ) to display the solution
Class comments
