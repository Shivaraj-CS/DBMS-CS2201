...
-- 'root@localhost', 'RVU-PC-033', '8.4.6', '2025-09-29 06:31:44'
...
-- Write the SQL Statement for the above Question
SELECT e.job_id, j.job_title, AVG(e.salary) AS average_salary
FROM employees e
...
-- Paste the output of above code and comment your output
/*# department_id	average_commission_pct
80	0.225000
	0.150000
*/
...
Due Sep 29
dear students
    solve the given queries for the existing database and update in GCR by end of day
